...
class SmartChatBot:
    def __init__(self, groq_api_key):
        ...
        self.llm = ChatGroq(
            ...
            model="llama3-70b-8192"  # Can change to a smaller model if needed
        )

        # Prompt template for LLM
        self.template = PromptTemplate.from_template(
            """You are a helpful AI assistant.
            Answer the following user query in a friendly and accurate way. Add emojis to make the conversation attractive.
            Question: {question}
            Answer:"""
        )
    ...
    def get_response(self, user_input):
        ...
        start_time = time.time()  # Start timer for latency monitoring
        ...
        # Optionally log the response time to monitor performance
